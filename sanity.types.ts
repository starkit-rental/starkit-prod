...
export type AllSanitySchemaTypes = ProductsPage | RichBody | AllPosts | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | FeatureCarousel | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | Hero2 | Hero1 | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | ProductCategory | Settings | Navigation | Testimonial | Faq | Category | Page | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Query: *[_type == "product" && slug.current == $slug][0] {    _id,    title,    "slug": slug.current,    booqableId,    excerpt,    description,    pricePerDay,    deposit,    status,    "images": images[].asset->url,    "category": category->{ title, "slug": slug.current },    specs,    blocks[] {      ...,      _type == "faqs" => {        ...,        items[]->      }    }  }
export type SingleProductQueryResult = {
  ...
  blocks: Array<{
    ...
    _type: "all-posts";
    padding?: SectionPadding;
    colorVariant?: "accent" | "background" | "card" | "destructive" | "muted" | "primary" | "secondary";
  } | {
    _key: string;
    _type: "carousel-1";
    padding?: SectionPadding;
...
// Query: *[_type == "productsPage"][0]{    title,    blocks[]{      ...,      _type == "faqs" => {        ...,        items[]->      }    },    seo  }
