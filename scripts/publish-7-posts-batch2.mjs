...
p("Wynajem Starlink Standard od Starkit to 59 zł/dzień. Dla firmy, która traci tysiące złotych na każdej godzinie bez internetu, to minimalna polisa ubezpieczeniowa. Przy dłuższych wynajmach stawka dzienna jest jeszcze niższa."),
h2("Jak zamówić?"),
...
h2("Koszty"),
p("Wynajem Starlink Mini od 39 zł/dzień, Standard od 59 zł/dzień. Na typowy weekend rajdowy (piątek-niedziela) to koszt kilkuset złotych za pełne pokrycie internetu na całym evencie. Dostarczamy kurierem w całej Polsce."),
h2("Podsumowanie"),
